package me.EctoDev.Krypter.font.ttf;
...
public class TTFManager {
	...
	private TTFRenderer TabGuiFont = null;
	...
	public TTFRenderer getLogoMainFont(){
		if(LogoMainFont == null){
			LogoMainFont = new TTFRenderer("Audiowide", Font.PLAIN, 48);
		}
		return LogoMainFont;
	}
	...
	public TTFRenderer getTabGuiFont() {
		if(TabGuiFont == null){
			TabGuiFont = new TTFRenderer("Audiowide", Font.PLAIN, 18);
		}
		return TabGuiFont;
	}
